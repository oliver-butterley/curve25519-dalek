...
/-- [core::iter::traits::iterator::Iterator::by_ref]:
    Source: '/rustc/library/core/src/iter/traits/iterator.rs', lines 1954:4-1956:20
...
/-- [core::iter::adapters::map::{impl core::iter::traits::double_ended::DoubleEndedIterator<B> for core::iter::adapters::map::Map<I, F>}::next_back]:
    Source: '/rustc/library/core/src/iter/adapters/map.rs', lines 148:4-148:40
    Name pattern: [core::iter::adapters::map::{core::iter::traits::double_ended::DoubleEndedIterator<core::iter::adapters::map::Map<@I, @F>, @B>}::next_back]
    Visibility: public -/
@[rust_fun
  "core::iter::adapters::map::{core::iter::traits::double_ended::DoubleEndedIterator<core::iter::adapters::map::Map<@I, @F>, @B>}::next_back"]
axiom
...
/-- [core::iter::adapters::rev::{impl core::iter::traits::iterator::Iterator<Clause0_Clause0_Item> for core::iter::adapters::rev::Rev<I>}::size_hint]:
    Source: '/rustc/library/core/src/iter/adapters/rev.rs', lines 56:4-56:49
    Name pattern: [core::iter::adapters::rev::{core::iter::traits::iterator::Iterator<core::iter::adapters::rev::Rev<@I>, @Clause0_Clause0_Item>}::size_hint]
    Visibility: public -/
@[rust_fun
  "core::iter::adapters::rev::{core::iter::traits::iterator::Iterator<core::iter::adapters::rev::Rev<@I>, @Clause0_Clause0_Item>}::size_hint"]
axiom core.iter.adapters.rev.Rev.Insts.CoreIterTraitsIteratorIterator.size_hint
  {I : Type} {Clause0_Clause0_Item : Type}
  (traitsdouble_endedDoubleEndedIteratorInst :
  core.iter.traits.double_ended.DoubleEndedIterator I Clause0_Clause0_Item) :
  core.iter.adapters.rev.Rev I → Result (Std.Usize × (Option Std.Usize))
...
/-- [core::iter::adapters::skip::{impl core::iter::traits::iterator::Iterator<Clause0_Item> for core::iter::adapters::skip::Skip<I>}::size_hint]:
    Source: '/rustc/library/core/src/iter/adapters/skip.rs', lines 91:4-91:49
    Name pattern: [core::iter::adapters::skip::{core::iter::traits::iterator::Iterator<core::iter::adapters::skip::Skip<@I>, @Clause0_Item>}::size_hint]
    Visibility: public -/
@[rust_fun
  "core::iter::adapters::skip::{core::iter::traits::iterator::Iterator<core::iter::adapters::skip::Skip<@I>, @Clause0_Item>}::size_hint"]
axiom
  ...
  core.iter.adapters.skip.Skip I → Result (Std.Usize × (Option Std.Usize))
...
/-- [core::iter::range::{impl core::iter::traits::iterator::Iterator<A> for core::ops::range::Range<A>}::size_hint]:
    Source: '/rustc/library/core/src/iter/range.rs', lines 989:4-989:49
...
/-- [core::iter::traits::iterator::{impl core::iter::traits::iterator::Iterator<Clause0_Item> for &'_0 mut I}::size_hint]:
    Source: '/rustc/library/core/src/iter/traits/iterator.rs', lines 4243:4-4243:49
...
/-- [core::option::{impl core::iter::traits::collect::FromIterator<core::option::Option<A>> for core::option::Option<V>}::from_iter]:
    Source: '/rustc/library/core/src/option.rs', lines 2762:4-2762:73
...
/-- [core::slice::iter::{impl core::iter::traits::iterator::Iterator<&'a mut T> for core::slice::iter::IterMut<'a, T>}::size_hint]:
    Source: '/rustc/library/core/src/slice/iter/macros.rs', lines 218:12-218:57
...
/-- [core::slice::iter::{impl core::iter::traits::double_ended::DoubleEndedIterator<&'_ mut T> for core::slice::iter::IterMut<'a, T>}::next_back]:
    Source: '/rustc/library/core/src/slice/iter/macros.rs', lines 438:12-438:52
    Name pattern: [core::slice::iter::{core::iter::traits::double_ended::DoubleEndedIterator<core::slice::iter::IterMut<'a, @T>, &'_ mut @T>}::next_back]
    Visibility: public -/
@[rust_fun
  "core::slice::iter::{core::iter::traits::double_ended::DoubleEndedIterator<core::slice::iter::IterMut<'a, @T>, &'_ mut @T>}::next_back"]
axiom
  core.slice.iter.IterMut.Insts.CoreIterTraitsDouble_endedDoubleEndedIteratorMutT.next_back
  {T : Type} :
  core.slice.iter.IterMut T → Result ((Option T) × (core.slice.iter.IterMut
    T) × (core.slice.iter.IterMut T → Option T → core.slice.iter.IterMut
    T))
...
/-- [alloc::vec::{impl core::iter::traits::collect::IntoIterator<&'a mut T, core::slice::iter::IterMut<'a, T>> for &'a mut alloc::vec::Vec<T>}::into_iter]:
    Source: '/rustc/library/alloc/src/vec/mod.rs', lines 3991:4-3991:40
    Name pattern: [alloc::vec::{core::iter::traits::collect::IntoIterator<&'a mut alloc::vec::Vec<@T>, &'a mut @T, core::slice::iter::IterMut<'a, @T>>}::into_iter]
    Visibility: public -/
@[rust_fun
  "alloc::vec::{core::iter::traits::collect::IntoIterator<&'a mut alloc::vec::Vec<@T>, &'a mut @T, core::slice::iter::IterMut<'a, @T>>}::into_iter"]
axiom MutAVec.Insts.CoreIterTraitsCollectIntoIteratorMutATIterMut.into_iter
  {T : Type} (A : Type) :
  alloc.vec.Vec T → Result ((core.slice.iter.IterMut T) ×
    (core.slice.iter.IterMut T → alloc.vec.Vec T))
