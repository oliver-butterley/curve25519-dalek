...
/-- [curve25519_dalek::backend::serial::scalar_mul::pippenger::{impl curve25519_dalek::traits::VartimeMultiscalarMul<curve25519_dalek::edwards::EdwardsPoint> for curve25519_dalek::backend::serial::scalar_mul::pippenger::Pippenger}::optional_multiscalar_mul::closure#5]
    Source: 'curve25519-dalek/src/backend/serial/scalar_mul/pippenger.rs', lines 159:37-159:80 -/
@[reducible]
def backend.serial.scalar_mul.pippenger.VartimeMultiscalarMulPippengerEdwardsPoint.optional_multiscalar_mul.closure_5
  (I : Type) (J : Type) (Clause0_Item : Type) (Clause0_IntoIter : Type)
  (Clause2_IntoIter : Type) :=
  Std.Usize

/-- [curve25519_dalek::backend::serial::scalar_mul::pippenger::{impl curve25519_dalek::traits::VartimeMultiscalarMul<curve25519_dalek::edwards::EdwardsPoint> for curve25519_dalek::backend::serial::scalar_mul::pippenger::Pippenger}::optional_multiscalar_mul::closure#4]
    Source: 'curve25519-dalek/src/backend/serial/scalar_mul/pippenger.rs', lines 112:54-154:9 -/
def backend.serial.scalar_mul.pippenger.VartimeMultiscalarMulPippengerEdwardsPoint.optional_multiscalar_mul.closure_4
  (I : Type) (J : Type) (Clause0_Item : Type) (Clause0_IntoIter : Type)
  (Clause2_IntoIter : Type) :=
  alloc.vec.Vec edwards.EdwardsPoint × alloc.vec.Vec ((Array Std.I8 64#usize)
  × backend.serial.curve_models.ProjectiveNielsPoint) × Std.Usize

/-- [curve25519_dalek::backend::serial::scalar_mul::pippenger::{impl curve25519_dalek::traits::VartimeMultiscalarMul<curve25519_dalek::edwards::EdwardsPoint> for curve25519_dalek::backend::serial::scalar_mul::pippenger::Pippenger}::optional_multiscalar_mul::closure#3]
    Source: 'curve25519-dalek/src/backend/serial/scalar_mul/pippenger.rs', lines 109:17-109:45 -/
@[reducible]
def backend.serial.scalar_mul.pippenger.VartimeMultiscalarMulPippengerEdwardsPoint.optional_multiscalar_mul.closure_3
  (I : Type) (J : Type) (Clause0_Item : Type) (Clause0_IntoIter : Type)
  (Clause2_IntoIter : Type) :=
Unit
...
/-- [curve25519_dalek::edwards::{curve25519_dalek::edwards::EdwardsPoint}::to_montgomery_batch::closure]
    Source: 'curve25519-dalek/src/edwards.rs', lines 601:46-601:61 -/
@[reducible]
def edwards.EdwardsPoint.to_montgomery_batch.closure := Unit
...
/-- [curve25519_dalek::edwards::{curve25519_dalek::edwards::EdwardsPoint}::compress_batch_alloc::closure#1]
    Source: 'curve25519-dalek/src/edwards.rs', lines 641:17-645:13 -/
@[reducible]
def edwards.EdwardsPoint.compress_batch_alloc.closure_1 := Unit

/-- [curve25519_dalek::edwards::{curve25519_dalek::edwards::EdwardsPoint}::compress_batch_alloc::closure]
    Source: 'curve25519-dalek/src/edwards.rs', lines 635:39-635:54 -/
@[reducible]
def edwards.EdwardsPoint.compress_batch_alloc.closure := Unit
...
/-- [curve25519_dalek::edwards::VartimeEdwardsPrecomputation]
    Source: 'curve25519-dalek/src/edwards.rs', lines 1038:0-1038:82
    Visibility: public -/
@[reducible]
...
/-- [curve25519_dalek::ristretto::{curve25519_dalek::ristretto::RistrettoPoint}::double_and_compress_batch::closure#1]
    Source: 'curve25519-dalek/src/ristretto.rs', lines 614:17-645:13 -/
@[reducible]
def ristretto.RistrettoPoint.double_and_compress_batch.closure_1 (I : Type)
  (Clause0_IntoIter : Type) :=
Unit

/-- [curve25519_dalek::ristretto::{curve25519_dalek::ristretto::RistrettoPoint}::double_and_compress_batch::BatchCompressState]
    Source: 'curve25519-dalek/src/ristretto.rs', lines 569:8-576:9 -/
structure ristretto.RistrettoPoint.double_and_compress_batch.BatchCompressState
  where
...
/-- [curve25519_dalek::ristretto::{curve25519_dalek::ristretto::RistrettoPoint}::double_and_compress_batch::closure]
    Source: 'curve25519-dalek/src/ristretto.rs', lines 607:60-607:80 -/
@[reducible]
def ristretto.RistrettoPoint.double_and_compress_batch.closure (I : Type)
  (Clause0_IntoIter : Type) :=
Unit
